...
//                getSdcardDir(), APP_FOLDER_NAME, NormalUtils.getTTSAppID());
    ...
    public void routeplanToNavi(final int coType) {
        if (!hasInitSuccess) {
        ...
        switch (coType) {
            ...
            case CoordinateType.BD09LL: {
                sNode = new BNRoutePlanNode(118.3828233073657, 31.45497236861682, "奇瑞汽车龙山试验中心", "奇瑞汽车龙山试验中心", coType);
                eNode = new BNRoutePlanNode(118.378619237579, 31.42494130419557, "奇瑞汽车股份有限公司研发楼", "奇瑞汽车股份有限公司研发楼", coType);
                break;
            }
            default:
                break;
